...
export default function FnFHeader({ 
  ...
  return (
    <div className={`flex flex-col items-start w-full bg-white sticky top-0 z-[200] transition-transform duration-300 ease-out ${
      ...
      <div className="sm:hidden w-full bg-white border-t-[4px] border-black border-solid">
        {/* Logo & Basket Row */}
        <div className="flex items-start justify-between px-[12px] py-0 h-[60px] w-full">
          ...
          <div className="flex gap-[16px] items-center pt-[12px] pb-[8px]">
            <button onClick={onWishlistClick} className="bg-white border-2 border-black rounded-[20px] p-[8px] relative hover:opacity-80 transition-opacity">
              ...
              {wishlistCount > 0 && (
                <div className="absolute -top-1 -right-1 bg-white text-black text-[11px] leading-[11px] font-bold rounded-full min-w-[18px] h-[18px] px-1 flex items-center justify-center border-2 border-black">
                  {wishlistCount}
                </div>
              )}
            </button>
            <button onClick={onBasketClick} className="flex items-center gap-[8px] hover:opacity-80 transition-opacity">
              ...
              <p className="font-['F&F_Sans'] font-bold text-[16px] leading-[20px] text-black">£{basketTotal.toFixed(2)}</p>
            </button>
          </div>
        </div>
        ...
        <div className="border-b border-[#cccccc] flex flex-col gap-[10px] pb-[12px] pt-[4px] px-[12px] w-full">
          <form onSubmit={handleSubmit} className="flex gap-[12px] items-start w-full">
            ...
            <button 
              type="submit"
              className="bg-black rounded-[20px] p-[8px] flex items-center justify-center flex-shrink-0 hover:bg-gray-800 transition-colors"
            >
