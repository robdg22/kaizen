...
export default function BasketSidebar({ isOpen, onClose, items, total, onRemoveItem, mode = 'tesco' }: BasketSidebarProps) {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="bg-white border-b border-[#cccccc] p-[12px] sm:p-4 flex items-center justify-between">
          <h2 className="font-['Tesco_Modern'] font-bold text-[18px] sm:text-[20px] leading-[22px] sm:leading-[24px] text-[#333333]">
            Your Basket
          </h2>
          <button
            onClick={onClose}
            className="text-[#333333] hover:opacity-80 transition-opacity p-1"
          >
